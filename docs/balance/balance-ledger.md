...
| Durable Passive day/rest lifecycle | Combat Lab now accepts and returns an explicit combat-local Active/Inactive Passive projection, but no Character or Monster campaign instance owns or persists those transitions across encounters or rests. | Define an authoritative campaign-day owner, rest reset rules, and out-of-combat cooldown advancement before adding durable storage. | Future campaign-day and rest persistence |
