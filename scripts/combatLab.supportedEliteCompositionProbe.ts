...
type ScenarioSpec = {
  name: string;
  packageType: "baseline" | "three-support-mixed" | "three-support-doubled" | "four-support-mixed" | "four-support-doubled";
  enemyNames: string[];
};
...
const SCENARIO_SPECS: ScenarioSpec[] = [
  ...
  {
    name: "Duelist three-support mixed",
    packageType: "three-support-mixed",
    enemyNames: ["BALANCE_Legendary Elite Duelist", "BALANCE_Physical Striker", "BALANCE_Durable Soldier", "BALANCE_Control Hexer"],
  },
  {
    name: "Hexer three-support mixed",
    packageType: "three-support-mixed",
    enemyNames: ["BALANCE_Legendary Elite Hexer", "BALANCE_Control Hexer", "BALANCE_Durable Soldier", "BALANCE_Physical Striker"],
  },
  {
    name: "Rotation three-support mixed",
    packageType: "three-support-mixed",
    enemyNames: ["BALANCE_Legendary Elite Breaker Controller Rotation", "BALANCE_Control Hexer", "BALANCE_Dodge Pressure Skirmisher", "BALANCE_Durable Soldier"],
  },
  {
    name: "Duelist three-support doubled",
    packageType: "three-support-doubled",
    enemyNames: ["BALANCE_Legendary Elite Duelist", "BALANCE_Physical Striker", "BALANCE_Physical Striker", "BALANCE_Durable Soldier"],
  },
  {
    name: "Hexer three-support doubled",
    packageType: "three-support-doubled",
    enemyNames: ["BALANCE_Legendary Elite Hexer", "BALANCE_Control Hexer", "BALANCE_Control Hexer", "BALANCE_Durable Soldier"],
  },
  {
    name: "Rotation three-support doubled",
    packageType: "three-support-doubled",
    enemyNames: ["BALANCE_Legendary Elite Breaker Controller Rotation", "BALANCE_Dodge Pressure Skirmisher", "BALANCE_Dodge Pressure Skirmisher", "BALANCE_Control Hexer"],
  },
  {
    name: "Duelist four-support mixed",
    packageType: "four-support-mixed",
    enemyNames: [
      "BALANCE_Legendary Elite Duelist",
      "BALANCE_Physical Striker",
      "BALANCE_Durable Soldier",
  ...
  {
    name: "Rotation four-support mixed",
    packageType: "four-support-mixed",
    enemyNames: [
      "BALANCE_Legendary Elite Breaker Controller Rotation",
      "BALANCE_Control Hexer",
  ...
  {
    name: "Duelist four-support doubled",
    packageType: "four-support-doubled",
    enemyNames: [
      "BALANCE_Legendary Elite Duelist",
      "BALANCE_Physical Striker",
      "BALANCE_Physical Striker",
  ...
  {
    name: "Hexer four-support doubled",
    packageType: "four-support-doubled",
    enemyNames: [
      "BALANCE_Legendary Elite Hexer",
      "BALANCE_Control Hexer",
  ...
  {
    name: "Rotation four-support doubled",
    packageType: "four-support-doubled",
    enemyNames: [
      "BALANCE_Legendary Elite Breaker Controller Rotation",
      "BALANCE_Dodge Pressure Skirmisher",
...
function parseArgs(argv: string[]): CliOptions {
  ...
  for (let index = 0; index < argv.length; index += 1) {
    ...
    if (arg === "--json") {
      ...
      console.log("Usage: npx --yes tsx scripts/combatLab.supportedEliteCompositionProbe.ts [--runs 100] [--seed 4242] [--json]");
      process.exit(0);
    }
  }
  return options;
...
function exactCommand(): string {
  return ["npx", "--yes", "tsx", "scripts/combatLab.supportedEliteCompositionProbe.ts", ...process.argv.slice(2)].join(" ");
}
...
function buildPayload(options: CliOptions, assets: Awaited<ReturnType<typeof loadAssets>>): Payload {
  ...
  return {
    title: "Balance Environment supported-Elite composition probe",
    provenance: {
