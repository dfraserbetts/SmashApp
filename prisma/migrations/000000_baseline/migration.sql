...
-- CreateEnum
CREATE TYPE "ItemType" AS ENUM ('WEAPON', 'ARMOR', 'SHIELD', 'ITEM', 'CONSUMABLE');
...
-- CreateEnum
CREATE TYPE "ForgeConfigCategory" AS ENUM ('RARITY', 'SIZE', 'ARMOR_LOCATION', 'ITEM_LOCATION', 'CONSUMABLES');
...
CREATE TABLE "ItemTemplate" (
    ...
    "GlobalAttributeModifiers" JSONB DEFAULT '[]',
    "CampaignID" TEXT NOT NULL,
    "meleeDamageTypeIds" INTEGER[],
    "rangedDamageTypeIds" INTEGER[],
    "aoeDamageTypeIds" INTEGER[],
    "PhysicalStrength" INTEGER,
    "MentalStrength" INTEGER,
    "meleePhysicalStrength" INTEGER,
    "meleeMentalStrength" INTEGER,
    "rangedPhysicalStrength" INTEGER,
    "rangedMentalStrength" INTEGER,
    "aoePhysicalStrength" INTEGER,
    "aoeMentalStrength" INTEGER,
...
CREATE TABLE "DamageType" (
    "id" SERIAL NOT NULL,
    "name" TEXT NOT NULL,
    "attackMode" TEXT NOT NULL DEFAULT 'PHYSICAL',
